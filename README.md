...
### Imagine Products - Changes

These changes were made to allow this to work with macOS versions earler than 10.15 since we support them and only exist in our private, forked Auth0 repo.
